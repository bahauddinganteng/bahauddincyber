...
clear
echo "SELAMAT DATANG DI APLIKASI HACK BY Bahauddin" | lolcat
echo "WE ARE PATI CYBER TEAM" ;read {$}
clear
figlet Bahauddin | lolcat
echo "●●●●●●●●●●●●●>| TOOL HACKING Bahauddin |<●●●●●●●●●●●●●" | lolcat
...
echo "■■■■■■■■■| TOOL HACKING Bahauddin |■■■■■■■■■■" | lolcat
echo "○○○○○○○○○○○○○○○○○○○○○○○○○○○○○○○○○○○○○○○" | lolcat     
echo "|☆☆| ●●●●●WE ARE PATI CYBER TEAM●●●●● |☆☆|" | lolcat
echo "|☆☆| 》》》》》》》》》》《《《《《《《《《《《" | lolcat
echo "|☆☆|                Wa: 085726833815                    |☆☆|" | lolcat
echo "|☆☆| FB KU : https://www.facebook.com/bahauddin.tayupati.9|☆☆|" | lolcat
echo "|○○○○○○○○| Created by Bahauddin |○○○○○○○○○|" | lolcat
echo "          |▪︎▪︎▪︎▪︎BLOGKU : http://cybernoobstayupati.blogspot.com/|          " | lolcat
echo "          ◇●●●●●●●●●●●●●●●●●●●●●●●●●●◇          "| lolcat
echo ""
echo ""
echo "===========================================" | lolcat
